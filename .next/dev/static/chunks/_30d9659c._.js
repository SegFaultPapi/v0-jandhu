...
function CartProvider({ children }) {
    ...
    const addToCart = (product, quantity = 1)=>{
        setItems((prevItems)=>{
            ...
            if (existingItem) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`${product.name} agregado al carrito (${newQuantity})`);
                return updatedItems;
            } else {
    ...
    const removeFromCart = (productId)=>{
        setItems((prevItems)=>{
            ...
            if (item) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`${item.name} eliminado del carrito`);
            }
...
//# sourceMappingURL=_30d9659c._.js.map
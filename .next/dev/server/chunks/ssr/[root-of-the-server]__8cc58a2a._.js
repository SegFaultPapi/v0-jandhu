...
;
const metadata = {
    title: "Juguetes Jandhu - Tu Tienda de Juguetes Online",
    description: "Encuentra los mejores juguetes con ofertas increíbles. Envío gratis en compras mayores a $50.",
    generator: "v0.app",
    icons: {
        icon: [
            {
